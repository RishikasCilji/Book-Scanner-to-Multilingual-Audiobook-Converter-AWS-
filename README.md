...
File is uploaded to S3 using a presigned URL.
S3 event triggers the processing Lambda.
Textract extracts text.
Translate converts text to target language.
Polly generates speech audio.
MP3 file is stored in S3 for playback.
...
How to Deploy
Backend Lambdas and S3 buckets must be created manually in AWS Console. source code included in this repository.
